...
const theme = {
  ...
  colors: {
    ...
    foreground900: '#0E0E0E',
    foreground800: tint(0.02, '#0E0E0E'),
    foreground700: tint(0.04, '#0E0E0E'),
    foreground600: tint(0.06, '#0E0E0E'),
    foreground500: tint(0.08, '#0E0E0E'),
    foreground400: tint(0.1, '#0E0E0E'),
    foreground300: tint(0.12, '#0E0E0E'),
    foreground200: tint(0.14, '#0E0E0E'),
    foreground100: tint(0.16, '#0E0E0E'),
